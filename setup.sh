...
setup_compose() {
	...
	curl -4 -fsSOL https://raw.githubusercontent.com/Ghostmxs/setup/"$GIT_BRANCH"/data/compose.yaml
...
create_make_default() {
	...
	curl -4 -fsSOL https://raw.githubusercontent.com/Ghostmxs/setup/"$GIT_BRANCH"/redash_make_default.sh
